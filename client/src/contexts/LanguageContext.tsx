...
const translations = {
  TR: {
    ...
    'contact.info.addressLine1': 'Teknoloji Vadisi, İnovasyon Caddesi No:42',
    'contact.info.addressLine2': 'Levent / İstanbul',
  ...
  EN: {
    ...
    'contact.info.addressLine1': 'Technology Valley, Innovation Street No:42',
    'contact.info.addressLine2': 'Levent / Istanbul',
