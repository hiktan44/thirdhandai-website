    ...
    <section id="hizmetler" className="py-20 bg-white/10 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-heading font-bold text-slate-900 mb-4">Hizmetlerimiz</h2>
          <p className="text-xl font-sans text-slate-800 font-medium max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {defaultServices.map((service, index) => (
            <Card key={index} className="bg-gradient-to-br from-amber-100 to-orange-100 backdrop-blur-sm border border-orange-300 hover:shadow-xl transition-all hover:border-orange-400 group cursor-pointer">
