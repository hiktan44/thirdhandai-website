export default function WorkProcessSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-50/95 to-blue-50/95 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-heading font-bold text-slate-800 mb-4">Çalışma Sürecimiz</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="text-center">
              ...
              <h3 className="text-xl font-heading font-semibold text-slate-800 mb-4">{step.title}</h3>
